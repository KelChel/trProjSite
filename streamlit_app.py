...
st.write('\tс Интересно, что значения активности крайне не стабильные, в 10 и 13 часов были пики активности, после которых были резкие спады. На 15 часах хоть количество постов и возрастало, на активность в положительную сторону это не влияло, соответственно, в выходные дни люди проявляли больше активности к постам, которые выходили в 10 и 13 часов, в промежутке между ними активность падала, но была стабильной.\tс Тут уже тексты от 100 слов практически такие же популярные как и тексты от 300 слов по лайкам, более бурные обсуждения же вызывали посты значением в 250 слов, а потом, по мере увеличения размерности текста активность обсуждений немного спадала, но не до критического уровня, как до этого. Но вместе с тем падала и частота выхода постов.\n В целом, стоит оставить текующее время выхода постов, но можно больше сконцентрироваться на их количестве в промежутке от 10 до 13 часов\n И публиковать лучше тексты до 100 слов. А также увеличить количество постов с 250+ словами, так как даже при своём малом количестве они вызывают высокую активность')
